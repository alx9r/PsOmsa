...
Import-Module PsOmsa

$here = Split-Path -Parent $MyInvocation.MyCommand.Path

$manifestPath   = "$here\PsOmsa.psd1"
...
Describe "manifest and changelog" {
    ...
    It "has a valid name in the manifest" {
        $script:manifest.Name | Should Be PsOmsa
    }

    It "has a valid guid in the manifest" {
        $script:manifest.Guid | Should Be '03539424-26c8-4e92-8ae2-12098f78fc31'
    }
...
Describe 'Style rules' {
    $moduleRoot = (Get-Module PsOmsa).ModuleBase
